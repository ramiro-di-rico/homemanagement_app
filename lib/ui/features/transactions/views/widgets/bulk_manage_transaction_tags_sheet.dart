...
class BulkManageTransactionTagsSheet extends StatefulWidget {
  final List<int> transactionIds;
  BulkManageTransactionTagsSheet({required this.transactionIds});

  @override
  State<BulkManageTransactionTagsSheet> createState() =>
      _BulkManageTransactionTagsSheetState();
}

class _BulkManageTransactionTagsSheetState
    extends State<BulkManageTransactionTagsSheet> {
  ...
  Future<void> _save() async {
    ...
    try {
      await _transactionRepository.bulkApplyTagsToTransactions(
          widget.transactionIds, _selected.map((t) => t.name).toList());
      if (!mounted) return;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              localizations.bulkTaggingTransactions(widget.transactionIds.length),
