...
class CategoryMetricService{
  ...
  CategoryMetricService({@required this.authenticationService, @required this.caching});
  ...
  Future<CategoriesMetric> getMostExpensiveCategories(int month) async {
    ...
    if(this.categoriesMetric == null){
      ...
      if(response.statusCode == 200){
        this.categoriesMetric = CategoriesMetric.fromJson(json.decode(response.body));
